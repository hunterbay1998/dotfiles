...
-- Default border for all floating windows (LSP hover, diagnostics, etc).
-- Neovim 0.11+ global option; plugins that don't set their own border
-- inherit this, which keeps float chrome consistent.
